...
pub trait Pack {
	fn to_packed_8888(&self)->u32;
	fn to_packed_s8s8s8s8(&self)->u32;
	fn to_packed_u10u10u10u2(&self)->u32;
	fn to_packed_s10s10s10u2(&self)->u32;

	fn to_packed_1555(&self)->u16;
	fn to_packed_565(&self)->u16;
	fn to_packed_4444(&self)->u16;
}
...
pub trait UnPack<V> {
//	fn to_vec4_from_8888(self)->V{self.unpack_8888()}
	fn to_vec4_from_8888(self)->V;
	fn to_vec4_from_1010102(self)->V;
	fn to_vec4_from_s10s10s10u2(self)->V;
}
pub trait UnPack16<V> {
	fn to_vec4_from_1555(self)->V;
	fn to_vec4_from_565(self)->V;
	fn to_vec4_from_4444(self)->V;
}

//32bit formats
impl UnPack<Vec4<f32>> for u32 {
	fn to_vec4_from_8888(self)->Vec4<f32> {
	...
	fn to_vec4_from_1010102(self)->Vec4<f32> {
	...
	fn to_vec4_from_s10s10s10u2(self)->Vec4<f32> {
		let r=(self &1023) as f32;
		let g=((self>>10) &1023 )as f32;
		let b=((self>>20) &1023) as f32;
		let a=((self>>30) &3) as f32;
...
impl UnPack16<Vec4<f32>> for u16 {
	fn to_vec4_from_1555(self)->Vec4<f32> {
